...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/nicolasvondolinger/Codes/FinWise/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/nicolasvondolinger/Codes/FinWise/prisma/schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  },
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "mysql://root:root@localhost:3306/finWise"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = \"mysql://root:root@localhost:3306/finWise\"\n}\n\nmodel User {\n  id    Int    @id @default(autoincrement()) // Chave primária com incremento automático\n  name  String\n  email String @unique // Restringe os valores para que sejam únicos na tabela\n}\n",
  "inlineSchemaHash": "6412039c3375c15b31cfe55115cf56a800d571783b93d93b8addcab8074f7867",
  "copyEngine": true
}
config.dirname = '/'
